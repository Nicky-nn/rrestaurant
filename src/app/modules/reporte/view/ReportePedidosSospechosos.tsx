...
const ReportePedidosSospechosos: FunctionComponent = () => {
  ...
  } = useRestAnomaliaPorSucursal({ codigoSucursal: sucursalSeleccionada.key })
  ...
  const handleGenerarStats = async () => {
    try {
      ...
      console.error(error)
      const errorMessage =
        error.response?.errors?.[0]?.message || error.message || 'Error al generar estadísticas'
        ...
        <Dialog open={openInfo} onClose={() => setOpenInfo(false)} maxWidth="sm" fullWidth>
          ...
          <DialogContent dividers>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Este módulo identifica pedidos con comportamiento inusual mediante un modelo computacional que
            ...
            <Grid container spacing={2}>
              <Grid size={{ xs: 12 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Selecciona un rango de fechas con actividad <em>rutinaria y normal</em> para enseñar al
                  sistema el patrón de ventas correcto de tu restaurante.
                </Typography>
              </Grid>
              <Grid size={{ xs: 12 }}>
                <Typography variant="subtitle2" fontWeight={700} color="text.primary">
                ...
                <Typography variant="body2" color="text.secondary">
                  Selecciona un nuevo rango de fechas para buscar pedidos que se desvían de lo normal,
                  comparándolos con el modelo previamente entrenado.
                </Typography>
              </Grid>
              <Grid size={{ xs: 12 }}>
                ...
                <Typography variant="body2" color="text.secondary" component="div">
                  ...
                  <ul style={{ paddingLeft: '20px', marginTop: '8px', marginBottom: 0 }}>
                    <li>
                      <strong>BAJO (0 a 14 pts):</strong> Operaciones rutinarias normales. No requieren
                      atención.
                    </li>
                    <li>
                      <strong style={{ color: '#ffb300' }}>MEDIO (15 a 24 pts):</strong> Comportamientos
                      ligeramente inusuales. No son necesariamente un fraude.
                    </li>
                    <li>
                      <strong style={{ color: '#f57c00' }}>ALTO (25 a 49 pts):</strong> Infracción directa a
                      límites o cambios financieros (descuentos manuales). Requiere revisión al final del día.
                    </li>
                    <li>
                      <strong style={{ color: '#d32f2f' }}>CRÍTICO (50+ pts):</strong> Alto riesgo de fraude
                      interno (ej. Anulación de pedido ya cobrado). Deben investigarse de inmediato.
                    </li>
                  </ul>
                </Typography>
              </Grid>
          ...
          <DialogActions>
            <Button onClick={() => setOpenInfo(false)} color="inherit">
              Entendido
            </Button>
          </DialogActions>
        </Dialog>
            ...
            {isStatsLoading ? (
              ...
              <Box p={3} textAlign="center">
                ...
                <Typography variant="body2" color="text.secondary" paragraph>
                  El reporte de pedidos sospechosos requiere un entrenamiento inicial basado en la actividad
                  histórica. Selecciona un rango de fechas con actividad rutinaria arriba y haz clic en
                  "Generar Stats".
                </Typography>
              </Box>
            ) : (
