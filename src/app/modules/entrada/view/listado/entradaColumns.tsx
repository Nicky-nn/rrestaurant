...
export const entradaColumns: MRT_ColumnDef<EntradaProps>[] = [
  ...
  },
  {
    ...
    size: 100,
    Cell: ({ row }) => (
      <MontoMonedaTexto monto={row.original.otrosCostos || 0} sigla={row.original.moneda.sigla} />
    ),
  },
  {
    ...
    enableColumnFilter: false,
    Cell: ({ row }) => (
      <MontoMonedaTexto monto={row.original.descuentoAdicional || 0} sigla={row.original.moneda.sigla} />
    ),
  },
  {
    ...
    enableColumnFilter: false,
    Cell: ({ cell, row }) => (
      <MontoMonedaTexto monto={cell.getValue<number>() || 0} sigla={row.original.moneda.sigla} />
    ),
  },
  {
