...
export const HistorialPedido = ({
  ...
  const ultimaFechaHistorial = historial.slice().sort((a, b) => b.nro - a.nro)[0]?.fecha ?? ''
  ...
  const hayCambios = filas.some(
    (item) => item.precioInicial !== item.precioFinal || item.cantidadInicial !== item.cantidadFinal,
  )
            ...
            {filas.map((item, index) => {
              ...
              return (
                <TableRow key={index} sx={{ padding: '8px' }}>
                  ...
                  <TableCell align="right" sx={cantidadDiferente ? { backgroundColor: amber[100] } : {}}>
                    {item.cantidadInicial}
                  </TableCell>
                  <TableCell align="right" sx={precioDiferente ? { backgroundColor: amber[100] } : {}}>
                  ...
                  <TableCell
                    align="right"
                    sx={precioDiferente || cantidadDiferente ? { backgroundColor: amber[100] } : {}}
                  >
