...
import { useSinMotivoAnulacion } from '../../../restaurante/queries/useSinMotivoAnulacion'
import { useRestNotaCreditoDebitoAnular } from '../../mutations/useRestNotaCreditoDebitoAnular'
...
interface OwnProps {
  ...
  factura: NotaCreditoDebito | null
}
