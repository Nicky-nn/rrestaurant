...
import { SalidaFacturaDetalle } from "../../restaurante/types";
...
export interface NotaDebitoCreditoDetalleInput {
  ...
  itemFactura: number;
  /** Cantidad del producto o servicio otorgado. En caso de servicio este valor debe ser 1. - Float con hasta 2 decimales - Número mayor a 0 */
  cantidad: number;
}
...
export interface RestNotaCreditoDebitoInput {
  /** Código único de la factura Original */
  facturaCuf: string;
  /** Email Alternativo, para notificaciones, este campo no reemplaza al email asociado al cliente */
  emailCliente?: string;
  /** Detalle de Items */
  detalle: NotaDebitoCreditoDetalleInput[];
  /** Usuario que realiza la transacción, en caso de no enviar, se asocia el nombre de usuario de la sesión activa */
  usuario?: string;
}
