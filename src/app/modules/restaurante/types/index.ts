...
export interface Articulo {
  ...
  /** Si es item solo para realización de compras administrativas - También aplica a articulos de tipo insumo */
  articuloCompra?: boolean;
  /** Si es true, el artículo es de producción interna. - Ejemplo Elaboración de Chantillý */
...
export interface WaapiEnviarUrlInput {
  /** Nombre del archivo - Ej. Factura 101211 - Pepito */
  nombre: string;
  /** Mensaje asociada al archivo - Ej. Empresa Pepito le enviar su factura por la compra nro 101010 */
  mensaje: string;
  /** Url del archivo */
  url: string;
  /** Código de area o region pais - Ej: 591 = Bolivia */
  codigoArea: string;
  /** Número de telefono */
  telefono: string;
}
...
export interface Waapi {
  /** Identificador único del registro. */
  _id?: string;
  /** Código de sucursal origen */
  codigoSucursal?: number;
  /** Código de punto de venta origen */
  codigoPuntoVenta?: number;
  /** Descripcion o titulo - En caso se envie archivo, se aplica a nombre de caption - En caso se envíe mensaje, se aplica a mensaje */
  mensaje?: string;
  /** Nombre del archivo */
  mediaName?: string;
  /** Path absoluto del archivo */
  mediaUrl?: string;
  /** Codigo de area o region pais - Ej: 591 = Bolivia */
  codigoArea?: string;
  /** Número de telefono al que se envía el mensaje */
  telefono?: string;
  /** Glosa del mensaje - La información no se envía en el mensaje */
  glosa?: string;
