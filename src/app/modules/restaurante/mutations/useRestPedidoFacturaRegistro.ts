...
export const useRestPedidoFacturaRegistro = (options?: UseMutationOptions<RestPedidoFactura, Error, RestPedidoFacturaRegistroVariables>) => {
  return useMutation<RestPedidoFactura, Error, RestPedidoFacturaRegistroVariables>({
    mutationFn: async (variables) => {
      const response = await client.request<{ restPedidoFacturaRegistro: RestPedidoFactura }>(RESTPEDIDOFACTURAREGISTRO, variables);
