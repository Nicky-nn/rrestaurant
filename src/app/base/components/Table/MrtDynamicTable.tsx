...
const mrtRowExpandColor = (
  theme: Theme,
  props: { dark?: number; light?: number } = {},
) =>
  alphaByTheme(
  ...
  const renderRowActions = useCallback(
    ({ row }: any) => (
      <Box sx={{ display: "inline-flex", gap: 0.5, alignItems: "center" }}>
        ...
        {config.showAudit && (
          <MrtAuditPopoverAction data={row.original as any} />
        )}
      </Box>
    ),
    [
