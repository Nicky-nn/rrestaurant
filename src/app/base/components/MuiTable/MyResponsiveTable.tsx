...
const StyledTh = styled("th", {
  ...
  const explicitTextColors = customTextColor
    ? getColor(theme, customTextColor)
    : null;
...
export const MyTable: React.FC<
  MyTableOptions & React.HTMLAttributes<HTMLTableElement>
> = ({
  dense,
  colorVariant,
  striped,
  ...
  return (
    <MyTableContext.Provider
      value={{ dense, colorVariant, striped, hover, bordered }}
    >
 ...
 * @constructor
 */
export const MyTableCaption: React.FC<
 ...
 * @constructor
 */
export const MyTableHead: React.FC<
 ...
 * @constructor
 */
export const MyTableRow: React.FC<
...
interface MyTableHeaderProps extends Omit<
...
interface MyTableCellProps extends Omit<
